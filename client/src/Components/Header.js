  ...
  function SpustajuciMeni() {
    ...
    function SpustajuciItem(props) {
      return (
        <a
          href="#"
          className="meni-item"
          onClick={() => props.goToMeni && setActiveMeni(props.goToMeni)}
        >
    ...
    return (
      <div className="spustanje" style={{ visina: meniVisina }}>
        ...
        >
          <div className="meni">
            <SpustajuciItem leftIcon={<Avatar />} onClick={handleClick()}>
              Moj Profil
            </SpustajuciItem>
            <SpustajuciItem
        ...
        >
          <div className="meni">
            ...
            <SpustajuciItem leftIcon={<ZubcanikIkonica />}>
              Opcije
            </SpustajuciItem>
            <SpustajuciItem leftIcon={<Katanac />}>
              Sigurnosne Opcije
            </SpustajuciItem>
            <SpustajuciItem leftIcon={<Upitnik />}>
              Pomoc i Podrska
            </SpustajuciItem>
          </div>
        </CSSTransition>
